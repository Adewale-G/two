/*
  # Fix faculties and departments schema

  1. New Migration
    - Fixes the error with the faculties table by removing the updated_at reference
    - Ensures all faculties and departments are properly inserted
    - Adds demo users and sample content
*/
...
-- Ensure faculties exist first (fixed by removing updated_at reference)
